  * [_Section 4 - Stock manipulation_](#section-4---stock-manipulation)
- [Article 9 - Etiquette](#article-9---etiquette)
  * [_Section 1 - Etiquette_](#section-1---etiquette)
- [Article 10 - Statistics](#article-10---statistics)
  * [_Section 1 - TagPro Analytics and TagPro League (TPL)_](#section-1---tagpro-analytics-and-tagpro-league--tpl)
  * [_Article 11 - Votes, Vetoes, VONC’s, & Rule Changes_](#article-11---votes--vetoes--vonc-s----rule-changes)
  * [_Section 2 - Rule Changes_](#section-2---rule-changes)
  * [_Section 3 - Vetoes_](#section-3---vetoes)
  * [_Section 4 - Vote of No Confidence (VONC)_](#section-4---vote-of-no-confidence--vonc)
...
- (1) Valid home servers will be:
   ...
   - (g) Seattle
   - (h) Central
- (2) Server splits will follow the official server chart
...
#### _Section 1 - The Chair and Rules Committee (CRC)_
...
- (3) Retirement.
   ...
   - (b) Members will retire based on the following order until 2 seats are open.
      - (i) Outgoing Chair from the previous Season.
      - (ii) Longest Tenured CRC member.
         - (1) If 2 members are tied for longest tenure (elected the same season), the one whose election format (Captains and CRC, or Community) is opposite the new Chair’s will retire.
...
- (4) Elections.
   ...
   - (e) The second seat will be filled by a vote of the NLTP Community from the remaining applicants.
      - (i) The NLTP Community is defined as:
         - (1) Players and Non-Playing Captains from the previous 3 seasons of NLTP.
         - (2) Players signed up for the current season’s draft at the time of ballot posting who’s last season of play was in NLTP. 
...
#### _Section 2 - The League Manager (LM)_
...
#### _Section 3 - Captains and Co-Captains_
- (1) Captaincy and Co-Captaincy structure overview.
   ...
   - (g) Co-captains are responsible for assisting the captain in team management, scrimmages, and anything else requested of them by the captain. Co-captains may be responsible for filling out forms on behalf of their captain with fair warning from the CRC. 
- (2) Eligibility and restrictions.
   ...
   - (b) Players who wish to DPC or NPCb may be restricted to NPC/IPC or DPC roles respectively by the CRC based on skill level and strength of signups.
      ...
      - (ii) A DPC signup will be considered overqualified if they meet any of the following criteria for their most recent season of NALTP:
         ...
         - (3) They played at least half of total available regular-season minutes in NLTP-A AND had a positional or total NISH of 90 or higher.
         - (4) The player is deemed by the CRC to be beyond the skill level of NLTP.
   - (c) Applicants who are likely to play in NLTP as decided by the CRC will be ineligible for NPC captaincy.
   - (d) CRC members may only captain as a last resort. They should not be considered an option unless they end up at a deficit for captains and have issued additional calls for more qualified captains.
      - (i) CRC captains automatically recuse themselves from:
         ...
         - (3) Any vote or discussion for a disciplinary action that would suspend a player on an opponent they are scheduled to face in the suspension period.
   ...
   - (f) Official Co-captains may not be decided or announced prior to the draft if there is a possibility of them playing in NLTP as decided by the CRC.
...
___  
### Article 3 - Drafting
#### _Section 1 - General draft information_
...
- (1) The snake draft will follow the same format for both traditional captaincy and General Manager seasons. 
   ...
   - (c) The team with the most prorated TCs will be 1st pick in the 1st round.
...
- (4) Acquisition process and procedure.
   ...
   - (b) There will be separate waiver orders for A- and A-teams.
   - (c) Free Agents will first be sent through the A-team wire; if they are passed on by each team they will then move on to the A-team wire.
   - (d) Free Agents who go unclaimed in the A-team wire will be auto-assigned to a team.
...
#### _Section 5 - Captain Specific Roster Changes_
...
#### _Section 6 - Dual Eligible Players (DEPs)_
...
#### _Section 1 - Positional restrictions_
...
#### _Section 2 - League restrictions_
- (1) Regular season.
...
#### _Section 3 - Scheduling restrictions_
   ...
   - (c) Game settings.
      ...
      - (ii) Half 2.
         ...
         - (2) Half 2 Overtime selected in the competitive stats script. Scores from half one are automatically input at the beginning of the half.
            - (a) Overtime on
            - (b) Overtime respawn increment: Disabled
            - (c) Overtime bonus Juke Juices: Disabled
...
- (2) Playoffs.
   - (a) Format.
      ...
      - (b) Maps and starting color.
         - (i) Captains will draft the maps and starting color according to the following:
            - (1) The team with the higher seed will pick what team they would like to be for the Pick/Pick (Team 1 or Team 2).
            - (2) The Pick/Pick must be completed between the two captains no less than 48 hours before the start time of a series and forwarded to the CRC.
            - (3) Teams will take turns picking from the available maps and assigning them to available games. The first pick may choose any map from the pool and assign it to any game from 1-7. The next team may choose any map except the first one and assign it to any remaining game, etc.
...
#### _Section 3 - Points and scoring_
...
#### _Section 4 - Minute minimums and maximums_
- (1) A-team.
...
- (2) B-team.
   - (a) There are no minute minimums for B-team games
...
- (2) Mid-late game
   ...
   - (b) Once timeout is called, the following must happen:
      ...
      - (v) Remember to save .eus from before and after the timeout, as TagProLeague can handle timeouts.
   - (c) Captains, official co-captains, and players in-game are the only group members permitted to call timeout.
...
- (2) Non-Players.
   - (a) For the duration of the game all microphones must be muted. Failure to mute may result in the awarding of waiver wire strikes or the deduction of points at the discretion of the CRC.
...
-(3) Tiebreakers between three or more teams with an equal number of points will be determined by the following:
   ...
   - (g) If the seeding of one team is determined in a three-or-more team tiebreaker but other seeds aren't, tiebreak rules continue as they are and do not reset for the remaining teams.
...
#### _Section 4 - Stock manipulation_
- (1) Draft stock.
...
#### _Section 1 - TagPro Analytics and TagPro League (TPL)_
- (1) TagPro Analytics
...
___
#### _Article 11 - Votes, Vetoes, VONC’s, & Rule Changes_
Section 1 - Votes.
...
- (3) If any member of the CRC is personally involved or their team is involved in a dispute that needs a ruling they will be forced to recuse themselves from the relevant CRC discussions, and subsequent vote. The rules committee can, at their discretion, question these recused members if they have inquiries during their investigation.
   - (a) For more information on recusal and tie breakers see Article II, Section 1.
...
#### _Section 4 - Vote of No Confidence (VONC)_
